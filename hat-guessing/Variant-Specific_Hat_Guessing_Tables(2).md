...
#### No Variant
* [3-Player](#no-variant--clue-starved-3-player)
* [4-Player](#no-variant--clue-starved--cow--pig-4-player--5-player)
* [5-Player](#no-variant--clue-starved--cow--pig-4-player--5-player)
* 6-Player
#### Rainbow
* [3-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-3-player)
* [4-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-4-player--5-player)
...
* 6-Player
#### White
* [3-Player](#white--brown--up-or-down-3-player)
* [4-Player](#white--brown--up-or-down-4-player--5-player)
* [5-Player](#white--brown--up-or-down-4-player--5-player)
* 6-Player
#### Brown
* [3-Player](#white--brown--up-or-down-3-player)
* [4-Player](#white--brown--up-or-down-4-player--5-player)
...
* 3-Player
* 4-Player
* [5-Player](#omni-5-player)
* 6-Player
#### Null
* 3-Player
* 4-Player
* [5-Player](#null-5-player)
* 6-Player
#### Muddy Rainbow
* 3-Player
* 4-Player
* [5-Player](#muddy-rainbow-5-player)
* 6-Player
#### Light Pink
* 3-Player
* 4-Player
* [5-Player](#light-pink-5-player)
* 6-Player
#### Ambiguous
* [3-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-3-player)
* [4-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-4-player--5-player)
...
* 6-Player
#### Extremely Ambiguous
* [3-Player](#extremely-ambiguous-3-player)
* [4-Player](#extremely-ambiguous-4-player--5-player)
* [5-Player](#extremely-ambiguous-4-player--5-player)
* 6-Player
#### Dual-Color
* [3-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-3-player)
* [4-Player](#rainbow--pink--ambiguous--very-ambiguous--dual-color-4-player--5-player)
...
* 6-Player
#### Number Blind
* [3-Player](#number-blind--totally-blind-3-player)
* [4-Player](#number-blind--totally-blind-4-player--5-player)
* [5-Player](#number-blind--totally-blind-4-player--5-player)
* 6-Player
#### Totally Blind
* [3-Player](#number-blind--totally-blind-3-player)
* [4-Player](#number-blind--totally-blind-4-player--5-player)
...
#### Color Mute
* 3-Player
* [4-Player](#color-mute--number-mute--alternating-clues--duck-4-player)
* [5-Player](#color-mute--number-mute--alternating-clues--duck-5-player)
* 6-Player
#### Number Mute
* 3-Player
* [4-Player](#color-mute--number-mute--alternating-clues--duck-4-player)
